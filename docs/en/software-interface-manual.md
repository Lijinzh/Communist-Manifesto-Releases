[简体中文](../zh-CN/software-interface-manual.md) | **English** | [Back to the complete guide](user-guide.md) | [Back to repository](../../README.en.md)
...
Return to the [complete user guide](user-guide.md) for Bluetooth pairing, wheel gestures, hardware ports, Skill installation, and troubleshooting.
